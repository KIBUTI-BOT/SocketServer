package com.kibuti.socketserver.GlobeAuthentication.Service.IMPL;

import com.fasterxml.jackson.core.JsonProcessingException;

import com.kibuti.socketserver.GlobeAdvice.Exceptions.*;
...
import com.kibuti.socketserver.GlobeAuthentication.DTOs.UserRegisterResponseDTO;
...
import com.kibuti.socketserver.GlobeAuthentication.Payloads.LoginResponse;
import com.kibuti.socketserver.GlobeAuthentication.Payloads.RefreshTokenResponse;
import com.kibuti.socketserver.GlobeAuthentication.Repository.GlobeUserRepository;
...
public class UserMGMTImpl implements UserManagementService {
    ...
    public GlobalJsonResponseBody registerUser(UserRegisterDTO userManagementDTO) throws UserExistException, RandomExceptions, JsonProcessingException, RandomExceptions {
        ...
        Roles userRoles = rolesRepository.findByRoleName("ROLE_KITCHEN_ADMIN").get();
        roles.add(userRoles);
        userManger.setRoles(roles);
        userManger.setIsVerified(true);
